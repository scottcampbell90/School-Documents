...
$EmailFrom = Trim(stripslashes($_POST['your-email'])); 
$EmailTo = "gregkerrpcc@gmail.com";
$Subject = "Message from Contact Form";
$YourName = Trim(stripslashes($_POST['your-name'])); 
...
$form_data = $current_date . "," . $EmailFrom . "," . $YourName . "," . $Comments . "\n";
