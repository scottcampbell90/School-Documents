...
$EmailFrom = trim(stripslashes($_POST['youremail'])); 
$EmailTo = "scottcamp503@gmail.com";
$Subject = "Message From Nifty Contact Form";
$Visitor = trim(stripslashes($_POST['yourname'])); 
$TripDate = trim(stripslashes($_POST['tripdate'])); 
...
if (($Visitor)=="") $validationOK=false;
if (!$validationOK) {
  print "<meta http-equiv=\"refresh\" content=\"0;URL=nifty/assets/error-validation.html\">";
  exit;
}
...
$form_data = $current_date . "," . $EmailFrom . "," . str_replace(",", "", $Visitor) . "," . str_replace(",", "", $Tripdate) . ",". str_replace(",", "", $Tours) . ",". str_replace(",", "", $Message) . "\n";
